...
#define WALNUT_SCREEN_WORKSPACE_PLAYLIST_HASH ""
#define WALNUT_SCREEN_WORKSPACE_PLAYLIST_LOOP 1
#define WALNUT_SCREEN_WORKSPACE_ITEM_COUNT 0
#define WALNUT_SCREEN_WORKSPACE_FRAME_COUNT 0
#define WALNUT_SCREEN_WORKSPACE_ITEM_ARRAY_COUNT 1
#define WALNUT_SCREEN_WORKSPACE_FRAME_ARRAY_COUNT 1
#define WALNUT_SCREEN_WORKSPACE_GENERATION_NOTE "Screen Workspace LVGL playback disabled for this build"
